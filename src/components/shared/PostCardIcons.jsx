  ...
  return (
    <div className="flex gap-3.5">
      ...
      <Link
        ...
        className="text-center text-gray-600 dark:text-gray-400 hover:bg-blue-200  hover:text-blue-500 dark:hover:text-blue-600 dark:hover:bg-blue-300 px-1.5 rounded-full"
      >
        <svg
      ...
      <div className="text-center cursor-pointer text-gray-600 dark:text-gray-400 hover:bg-blue-200  hover:text-blue-500 dark:hover:text-blue-600 dark:hover:bg-blue-300 p-1 rounded-full">
        <svg
          className="w-5 h-5 mx-1 transform rotate-45"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 18 22"
